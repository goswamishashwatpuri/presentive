...
import { CustomImage } from '@/components/global/editor/image-component'
import { BlockQuote } from '@/components/global/editor/blockquote'
import { NumberedList, BulletList, TodoList } from '@/components/global/editor/list-component'
      ...
      return (
        <motion.div {...animationProps} className='w-full h-full'>
          <TableComponent
            ...
            onChangeCustom={(newContent) => onContentChange(content.id, newContent !== null ? newContent : '')}
